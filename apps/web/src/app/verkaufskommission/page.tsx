...
const ablauf = [
  {
    ...
    text: 'Kurzes Profil: Ihre Kanäle, Reichweite, Erfahrung. Wir prüfen die Eignung und melden uns innerhalb von 48 Stunden.',
  },
  {
    nr: 2,
    icon: Package,
    titel: 'Sortiment erhalten',
    text: 'Wir stellen geeignete Markenprodukte für Ihre Kanäle bereit — abgestimmt auf Ihre Zielgruppe und Plattform.',
  },
  {
    nr: 3,
    icon: ShoppingCart,
    titel: 'Verkauf abwickeln',
    text: 'Sie listen, verkaufen und betreuen den Kundenkontakt. Wir unterstützen mit Produktdaten und Bildmaterial.',
  },
  {
    nr: 4,
    icon: CreditCard,
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-10 leading-relaxed">
              Verkaufen Sie für uns —{' '}
              <span className="text-[#D4AF37] font-semibold">wir liefern Produkte</span>,
