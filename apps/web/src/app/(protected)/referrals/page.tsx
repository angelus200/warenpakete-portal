    ...
    <div className="min-h-screen bg-[#ebebeb]">
      <div className="container mx-auto px-4 py-3">
        <div className="mb-3">
          ...
          <p className="text-gray-600">Verdienen Sie 20% Provision auf jeden vermittelten Verkauf</p>
        </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1 bg-[#ebebeb] border-2 border-gold rounded-lg px-3 py-4">
                    ...
                    <button
                      ...
                      className="px-3 py-4 bg-gold/10 hover:bg-gold/20 text-gold border-2 border-gold rounded-lg transition-colors font-medium"
                    >
                      Kopieren
                    </button>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
          <Card className="p-3 bg-white border-gray-300 hover:border-gold transition-colors">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm text-gray-600 font-medium">Provisionen ausstehend</h3>
          ...
          <Card className="p-3 bg-white border-gray-300 hover:border-gold transition-colors">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm text-gray-600 font-medium">Provisionen bezahlt</h3>
          ...
          <Card className="p-3 bg-white border-gray-300 hover:border-gold transition-colors">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-sm text-gray-600 font-medium">Gesamt verdient</h3>
        ...
        <Card className="p-4 bg-white border-gray-300">
          <h2 className="text-lg font-bold text-gray-900 mb-3">Provisionsverlauf</h2>
          {commissions && commissions.length > 0 ? (
            <div className="space-y-4">
              {commissions.map((commission) => (
                <div key={commission.id} className="p-5 bg-[#ebebeb] rounded-lg border border-gold/10 hover:border-gold/30 transition-colors">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <p className="font-bold text-gray-900 text-lg mb-1">
                        Bestellung #{commission.order.id.slice(0, 8).toUpperCase()}
                      </p>
                      <p className="text-sm text-gray-600">Kunde: {commission.order.user.email}</p>
                      ...
                      <span
                        className={`inline-block px-3 py-1 rounded-full text-xs font-bold border ${
                          commission.status === 'PAID'
                            ...
                            : 'bg-gray-500/20 text-gray-600 border-gray-500/40'
                        }`}
                      >
                        {commission.status}
                      </span>
            ...
            <div className="text-center py-3">
              ...
              <p className="text-gray-600 text-lg mb-2">Noch keine Provisionen verdient</p>
