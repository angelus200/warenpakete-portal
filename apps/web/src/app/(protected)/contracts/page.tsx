    ...
    <div className="min-h-screen bg-dark">
      <div className="container mx-auto px-4 py-12">
        ...
        {!contracts || contracts.length === 0 ? (
          <Card className="p-12 bg-dark-light border-gold/20 text-center">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-2">Keine Verträge vorhanden</p>
              <p className="text-gray-500 mb-6">
                Wenn Sie eine Bestellung mit Verkaufskommission wählen, wird hier ein Vertrag angezeigt.
              </p>
              <Link
                href="/orders"
                className="inline-block px-6 py-3 bg-gradient-to-r from-gold-dark via-gold to-gold-light hover:from-gold-darker hover:via-gold-dark hover:to-gold text-dark font-bold rounded-lg shadow-lg shadow-gold/20 transition-all"
              >
          ...
          <div className="space-y-6">
            {contracts.map((contract) => (
              <Link key={contract.id} href={`/contracts/${contract.id}`}>
                <Card className="p-6 bg-dark-light border-gold/20 hover:border-gold/40 transition-all cursor-pointer">
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                    {/* Contract Number & Date */}
                    <div className="md:col-span-3">
                      <p className="text-sm text-gray-400 mb-1">Vertragsnummer</p>
                    ...
                    {/* Sales Status */}
                    <div className="md:col-span-2">
                      <p className="text-sm text-gray-400 mb-1">Verkaufsstatus</p>
